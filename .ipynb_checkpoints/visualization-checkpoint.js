class MotionVisualizer {
    ...
    async tryLoadDtwFromRelative() {
        ...
        try {
            const base = 'IB-results/DTW-model-files/';
    ...
    loadCellVideo(row, col) {
        ...
        const videoPath = `IB-results/videos/video-${row}-${col}.mp4`;
        ...
        this.cellVideo.addEventListener('loadedmetadata', () => {
            ...
            const baseWidth = 200; // Reduced by half from original 400
            const baseHeight = 150; // Reduced by half from original 300
            ...
            if (aspectRatio > baseWidth / baseHeight) {
                ...
                newWidth = baseHeight * aspectRatio;
            }
